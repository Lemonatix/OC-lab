...
Es werden \SI{13.12}{\gram} (\SI{50}{\milli\mole}) Triphenylphosphan mit \SI{5.94}{\milli\liter} (\SI{50}{\milli\mole}) Benzylbromid und \SI{75}{\milli\liter} Toluol versetzt. Dieses milchfarbene Gemisch wird mithilfe eines Ölbads, welches auf \SI{115}{\degreeCelsius} eingestellt ist für 48h mit einem Findenser gekocht. 
